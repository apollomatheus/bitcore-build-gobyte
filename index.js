...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-gobyte/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-gobyte -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-gobyte -o bitcore-lib-gobyte.js';
    }
